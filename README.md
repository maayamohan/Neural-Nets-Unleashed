I was first introduced to Neural Networks through a PESU I/O course called Neural Nets Unleashed. Some of the files in this directory are created my the SMEs that conducted the course.
- CNNs.ipynb
